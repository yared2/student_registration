...
public class AttendanceController {
	...
	@GetMapping("/session/{sessionId}/courseOffering/{courseOfferingId}/course/{courseId}")
	@JsonView(AttendanceDTO.SummaryView.class)
	public List<AttendanceDTO> fetchAttendanceSummary(@PathVariable("sessionId") Long sessionId,
			@PathVariable("courseOfferingId") Long courseOfferingId, @PathVariable("courseId") Long courseId) {
		List<AttendanceDTO> list = (List<AttendanceDTO>) attendanceService.fetchAttendanceSummary(sessionId,
